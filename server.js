...
app.post('/API/EmailVerification', async (req, res, next) =>
{
  ...
  const msg = {
    ...
    text: 'Here is the confirmation code you need to login to Cinemates.CODEIf you did not request this code, please change your passsword and consider changing your email password as well to ensure your account security.',
    html: '<p style="color:black">Here is the confirmation code you need to login to Cinemates.</strong></p><p style="color:blue">CODE</p><p style="color:black"><b>If you did not request this code<b>, please change your passsword and consider changing your email password as well to ensure your account security.</strong></p>',
  }
